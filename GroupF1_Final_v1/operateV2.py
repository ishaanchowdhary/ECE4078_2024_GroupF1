...
class Operate:
    ...
    def draw(self, canvas: pygame.surface):
        ...
        notifiation = Operate.TEXT_FONT.render(self.notification,
                                       False, text_colour)
        ...
        if time_remain > 0:
            ...
            time_remain = ""
        count_down_surface = Operate.TEXT_FONT.render(time_remain, False, (50, 50, 50))
    ...
    def put_caption(canvas, caption, position, text_colour=(200, 200, 200)):
        caption_surface = Operate.TITLE_FONT.render(caption,
                                            False, text_colour)
