    ...
    def _get_bounding_boxes(self, cv_img):
        ...
        for prediction in predictions:
            ...
            for box in boxes:
                ...
                if (prediction.names[int(box_label)] != 'orange'):
...
if __name__ == '__main__':
    ...
    yolo = Detector(f'{script_dir}/model/best.pt') #03_09_Ibest15

    img = cv2.imread('C:/Users/yeeka/OneDrive/Documents/MonashY3S2/ECE4078/ECE4078_Lab_2024/Week05-06/YOLO/test/Image3.jpg')
    ...
    #     img_path = fr'C:\Users\yeeka\OneDrive\Documents\MonashY3S2\ECE4078\ECE4078_Lab_2024\Week05-06\YOLO\test\Image{i}.jpg'
    #     print(img_path)
    ...
    #     cv2.imshow('yolo detect', img_out)
    #     cv2.waitKey(0.5)
        # next = input("Press space for next image: ")
        # if next:
        #     continue
